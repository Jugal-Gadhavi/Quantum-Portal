...
interface QualityEngineerProps{}

const QualityEngineerDesc: FC<QualityEngineerProps> = ()=>{
    const [expanded, setExpanded] = useState<boolean>(false);

    return(
        <div className="font-normal">
      <div className="flex justify-between bg-[#DBEFFF] mx-4 font-semibold py-3 rounded-sm drop-shadow-lg">
        <div className="p-4 text-xl">Software Quality Engineer</div>
...
export default QualityEngineerDesc;